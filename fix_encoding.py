...
nav_target = '<a href="sap_s4hana_ebook/index.html"'
nav_replacement = '<a href="knowledge-graph/index.html" style="color:#e879f9;background:rgba(217,70,239,.15);border-color:rgba(217,70,239,.3);font-weight:800;"><i class="fa-solid fa-diagram-project" style="font-size:10px"></i> 13.🕸️ Knowledge Graph</a>\n          <a href="sap_s4hana_ebook/index.html"'
...
print('Done fixing UTF-8 encoding!')
