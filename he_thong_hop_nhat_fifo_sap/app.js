// WMS VĐT - UNIFIED FIFO & SAP S/4HANA Dynamic Warehouse System Logic
// Supports Dynamic Filtered Stats, Multi-Unit Breakdown, Theme Switcher, and Client-Side Instant Matrix Rendering
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // --------------------------------------------------------------------------
    // 3. DYNAMIC FILTERED STATS BANNER UPDATE
    // --------------------------------------------------------------------------
    function updateFilteredStatsBanner(filteredArray) {
        ...
        const scopeLabel = scopeParts.length > 0 ? scopeParts.join(' | ') : 'Tất cả kho Hợp Nhất';
    ...
    inputFifoFile.addEventListener('change', (e) => {
        ...
        displayProcessStatus.textContent = 'Đã chọn file thành công. Bấm Bước 2 để chạy Hợp Nhất!';
    ...
    btnProcess.addEventListener('click', () => {
        displayProcessStatus.textContent = 'Đang tính toán phân bổ FIFO & map vị trí SAP...';
        
        setTimeout(() => {
            displayProcessStatus.textContent = '✅ Đã hợp nhất xuất kho FIFO & chuẩn hóa vị trí SAP thành công!';
            displayProcessStatus.className = 'process-status text-green';
    ...
    btnDownload.addEventListener('click', () => {
        ...
        a.href = 'KET_QUA_HOP_NHAT_FIFO_SAP.xlsx';
        a.download = 'KET_QUA_HOP_NHAT_FIFO_SAP.xlsx';
